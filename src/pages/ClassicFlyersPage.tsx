    ...
    <div className="min-h-screen bg-[#0B0F17] pt-28 pb-20">
      <div className="rp-container">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="mb-6">
          <Link to="/products/flyers-leaflets" className="group inline-flex items-center gap-2.5 px-4 py-2 rounded-xl bg-[rgba(59,108,255,0.08)] border border-[rgba(59,108,255,0.25)] text-sm font-medium text-[#A6B0C5] hover:text-[#F6F8FF] hover:bg-[rgba(59,108,255,0.15)] hover:border-[rgba(59,108,255,0.5)] hover:shadow-lg hover:shadow-[#3B6CFF]/20 transition-all duration-300">
        ...
        <div className="grid xl:grid-cols-12 gap-8 lg:gap-12">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="xl:col-span-7">
            ...
            <div className="space-y-4 mb-8">
              <h3 className="text-lg font-semibold text-[#F6F8FF] mb-4">Configure Your Flyers</h3>
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex items-center justify-between px-4 py-2.5 rounded-xl border text-sm transition-all ${
                        isSelected
                          ? 'border-[#3B6CFF] bg-[rgba(59,108,255,0.10)]'
                          : 'border-[rgba(246,248,255,0.10)] bg-[rgba(246,248,255,0.03)] hover:border-[rgba(246,248,255,0.20)]'
                      } ${isRec ? 'mt-5' : ''}`}
                    >
                      {isRec && (
                      ...
                      <span className={`font-medium ${isSelected ? 'text-[#F6F8FF]' : 'text-[#A6B0C5]'}`}>
                        {tier.quantity.toLocaleString()}
                      </span>
                      <span className={`font-semibold ${isSelected ? 'text-[#F6F8FF]' : 'text-[#A6B0C5]'}`}>
            ...
            <div className="mb-8">
              ...
              {uploadedArtwork ? (
                <div className={`p-4 rounded-xl border flex items-center justify-between ${
                  isUploadingArtwork ? 'bg-[rgba(246,168,0,0.08)] border-[rgba(246,168,0,0.3)]' : 'bg-[rgba(59,108,255,0.1)] border-[rgba(59,108,255,0.3)]'
                }`}>
                  <div className="flex items-center gap-3">
