    ...
    <div className="min-h-screen bg-white pt-28 pb-20">
      ...
      <div className="rp-container">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <Link to={`/products/${product.category}`} className="group inline-flex items-center gap-2.5 px-4 py-2 rounded-xl bg-blue-50 border border-blue-200 text-sm font-medium text-[#3B6CFF] hover:bg-blue-100 hover:border-[#3B6CFF]/50 hover:shadow-md transition-all duration-300">
        ...
        <div className="grid xl:grid-cols-12 gap-8 lg:gap-12">
          ...
          >
            <div className="aspect-[4/3] rounded-[24px] overflow-hidden mb-4 bg-slate-100 shadow-md">
              <img
                src={product.image}
                alt={product.name}
            ...
            <div className="mb-8">
              ...
              {uploadedArtwork ? (
                <div className={`p-4 rounded-xl border flex items-center justify-between ${isUploadingArtwork ? 'bg-amber-50 border-amber-200' : 'bg-blue-50 border-blue-200'}`}>
                  ...
                  {!isUploadingArtwork && (
                    <button
                      ...
                      className="text-sm text-[#64748B] hover:text-red-500 transition-colors font-medium"
                    >
                      Remove
                    </button>
                  )}
                ...
                <button
                  ...
                  className="w-full p-6 rounded-xl border-2 border-dashed border-slate-300 hover:border-[#3B6CFF] bg-white hover:bg-blue-50 transition-all text-center group"
                >
                  <Upload className="w-8 h-8 text-[#64748B] mx-auto mb-2 group-hover:text-[#3B6CFF] transition-colors" />
                  <p className="text-sm font-medium text-[#0F172A] mb-1">Click to upload artwork</p>
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#3B6CFF] to-[#5a85ff] hover:from-[#2a5aee] hover:to-[#4a75f0] text-white py-6 text-base shadow-lg shadow-[#3B6CFF]/25 hover:shadow-[#3B6CFF]/40 transition-all"
                >
              ...
              {relatedProducts.map((product, index) => (
                ...
                >
                  <Link to={`/product/${product.slug}`}>
                    <div className="group rp-card overflow-hidden hover:border-[rgba(59,108,255,0.3)] hover:shadow-lg transition-all duration-300">
