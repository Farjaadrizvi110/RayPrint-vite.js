    ...
    <div className="min-h-screen bg-[#0B0F17] pt-28 pb-20">
      <div className="rp-container">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <Link to={`/products/${product.category}`} className="group inline-flex items-center gap-2.5 px-4 py-2 rounded-xl bg-[rgba(59,108,255,0.08)] border border-[rgba(59,108,255,0.25)] text-sm font-medium text-[#A6B0C5] hover:text-[#F6F8FF] hover:bg-[rgba(59,108,255,0.15)] hover:border-[rgba(59,108,255,0.5)] hover:shadow-lg hover:shadow-[#3B6CFF]/20 transition-all duration-300">
