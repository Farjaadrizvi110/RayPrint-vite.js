...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Account created successfully! Welcome to RayPrint 🎉');
      navigate('/account');
    } catch {
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  <label className="flex items-start gap-3 cursor-pointer select-none">
                    {/* Real checkbox — visually hidden but functional */}
                    ...
                    <span className="text-sm text-[#A6B0C5] leading-relaxed">
                      ...
                      {' '}and{' '}
                      <a href="#" onClick={e => e.stopPropagation()} className="text-[#3B6CFF] hover:underline">Privacy Policy</a>
                    </span>
                  </label>
                </motion.div>
